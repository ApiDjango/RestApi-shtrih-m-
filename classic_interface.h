#ifndef CLASSIC_INTERFACE_H
#define CLASSIC_INTERFACE_H
...
#define CLASSIC_FR_DRV_NG_HELPER_DLL_IMPORT __declspec(dllimport)
#define CLASSIC_FR_DRV_NG_HELPER_DLL_EXPORT __declspec(dllexport)
#define CLASSIC_FR_DRV_NG_HELPER_DLL_LOCAL
#else
#if __GNUC__ >= 4
#define CLASSIC_FR_DRV_NG_HELPER_DLL_IMPORT __attribute__((visibility("default")))
#define CLASSIC_FR_DRV_NG_HELPER_DLL_EXPORT __attribute__((visibility("default")))
#define CLASSIC_FR_DRV_NG_HELPER_DLL_LOCAL __attribute__((visibility("hidden")))
#else
#define CLASSIC_FR_DRV_NG_HELPER_DLL_IMPORT
#define CLASSIC_FR_DRV_NG_HELPER_DLL_EXPORT
#define CLASSIC_FR_DRV_NG_HELPER_DLL_LOCAL
#endif
#endif

// Now we use the generic helper definitions above to define CLASSIC_FR_DRV_NG_API and
// CLASSIC_FR_DRV_NG_LOCAL. CLASSIC_FR_DRV_NG_API is used for the public API symbols. It either DLL
// imports or DLL exports (or does nothing for static build) CLASSIC_FR_DRV_NG_LOCAL is used for
// non-api symbols.

#ifdef CLASSIC_FR_DRV_NG_DLL // defined if CLASSIC_FR_DRV_NG is compiled as a DLL
#ifdef CLASSIC_FR_DRV_NG_DLL_EXPORTS // defined if we are building the CLASSIC_FR_DRV_NG DLL (instead of using it)
#define CLASSIC_FR_DRV_NG_API CLASSIC_FR_DRV_NG_HELPER_DLL_EXPORT
#else
#define CLASSIC_FR_DRV_NG_API CLASSIC_FR_DRV_NG_HELPER_DLL_IMPORT
#endif // CLASSIC_FR_DRV_NG_DLL_EXPORTS
#define CLASSIC_FR_DRV_NG_LOCAL CLASSIC_FR_DRV_NG_HELPER_DLL_LOCAL
#else // CLASSIC_FR_DRV_NG_DLL is not defined: this means CLASSIC_FR_DRV_NG is a static lib.
#define CLASSIC_FR_DRV_NG_API
#define CLASSIC_FR_DRV_NG_LOCAL
#endif // CLASSIC_FR_DRV_NG_DLL

#ifndef DOXYGEN_PROPERTY
#define DOXYGEN_PROPERTY(...)
#endif

class CLASSIC_FR_DRV_NG_API classic_interface {
public:
    //!
...
public:
    ...
    //!
    //! @par Используется методом:
    //!   #LoadImage, #FNSaveArchive, #LoadFont
    //!
    //! @par Методы доступа:
    ...
    //! |----------|------------------------------------------|---------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
    //! | tcp      | tcp сокет                                | ip:[port] по умолчанию порт 7778                                    | plain_transfer=auto, автоматически пытаться переводить протокол в режим надежной передачи при подключении.   |
