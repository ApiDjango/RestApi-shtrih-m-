...
swig_options = ['-module', 'fr_drv_ng', '-c++', '-modern', '-modernargs', '-builtin']

libraries = ['classic_fr_drv_ng']
...
classic_python_fr_drv_ng_module = Extension('_fr_drv_ng', ['classic_interface.i'],
...
setup(name='fr_drv_ng',
      version='1.0',
      cmdclass={'build': CustomBuild, 'install': CustomInstall},
      author="Shtrih-M",
      description="""Simple swig wrapper for classic_fr_drv_ng driver""",
      ext_modules=[classic_python_fr_drv_ng_module],
      py_modules=["fr_drv_ng"],
